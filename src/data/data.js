export const personalInfo = {
  ...
  bio: "An innovative and detail-oriented software developer with a passion for building dynamic and user-friendly web applications. Experienced in developing responsive, high-performance websites using modern frameworks like React.js and Vue.js. Currently pursuing an Integrated M.Tech in Information Technology from IIITM Gwalior, I am eager to apply my skills in a challenging and growth-oriented environment.",
  about: "I am a passionate and driven software developer with a strong foundation in computer science fundamentals, including Data Structures, Algorithms, and Object-Oriented Programming. My journey in web development began with a desire to create seamless and engaging digital experiences. I thrive in collaborative environments and enjoy tackling complex problems to deliver efficient and scalable solutions. As the Executive Head at E-Cell, IIIT Gwalior, I have honed my leadership skills by fostering innovation within the student community. I am committed to continuous learning and am always exploring new technologies to enhance my skill set.",
...
export const projects = [
  {
    id: 1,
    title: "Collab-io",
    description: "A real-time collaborative code editor that enables multiple users to join and edit simultaneously using unique room IDs. The application features real-time data streaming via WebSockets.",
  ...
  },
  {
    id: 2,
    title: "Flixir",
    description: "A MERN-based social media web application with features including user authentication, CRUD operations for posts, likes, and comments.",
